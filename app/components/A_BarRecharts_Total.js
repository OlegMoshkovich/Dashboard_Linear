...
function BarRecharts(props){
  ...
  ? <div>Loading Risk Levels</div>
  :<div>


  <div className = "col-sm-12 text-center" >
    <h3>{title} </h3>
  <ComposedChart width={chartWidth} height={300} data={data} margin={{top: 5, right: 30, left: 20, bottom: 5}}>
         ...
         <Line type='monotone' dataKey='RiskLevel' stroke='#ff7300'/>

         <Bar dataKey="RiskLevel" fill="#e05915" />
